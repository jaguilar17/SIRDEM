<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_GraficaMesomorfiaxJugador.aspx.cs" Inherits="WebApp.frm_GraficaMesomorfiaxJugador" %>
    ...
    <script>
        ...
        function ListaPubli() {
            $.ajax({
                ...
                url: "../frm_GraficaMesomorfiaxJugador.aspx/MesomorfiaxJugador",
                data: "{}",
                dataType: "json",
                success: function (Result) {
                    ...
                    var data = [];
                    for (var i in Result) {
                        var serie = new Array(Result[i].fechaControl, Result[i].mesomorfia);
                        data.push(serie);
                    }
                    DibujaGrafico(data);
        ...
        function DibujaGrafico(series) {
            $('#grafico').highcharts({
                ...
                title: {
                    text: 'Resultados de Mesomorfia por Controles'
                },
                subtitle: {
                    text: ''
                },
