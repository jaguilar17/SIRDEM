<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_GraficaEndomorfiaxJugador.aspx.cs" Inherits="WebApp.frm_GraficaEndomorfiaxJugador" %>
    ...
    <script>
        ...
        function ListaPubli() {
            $.ajax({
                ...
                url: "../frm_GraficaEndomorfiaxJugador.aspx/EndomorfiaxJugador",
                data: "{}",
                dataType: "json",
                success: function (Result) {
                    ...
                    var data = [];
                    for (var i in Result) {
                        var serie = new Array(Result[i].fechaControl, Result[i].endomorfia);
                        data.push(serie);
                    }
                    DibujaGrafico(data);
        ...
        function DibujaGrafico(series) {
            $('#grafico').highcharts({
                ...
                title: {
                    text: 'Resultados de Endomorfia por Controles'
                },
                subtitle: {
                    text: ''
                },
                ...
                series: [{
                    name: 'Endomorfo Meta',
                    data: [2.4, 2.8, 3.2, 3.6, 3.6, 4.2, 5.2]
                }, {
