...
<body>
 ...
 <section class="container-fluid" id="section1">
    <div class="v-center">
        ...
        <p class="text-center">
            <br>
            <a href="#" class="btn btn-danger btn-lg btn-huge lato" data-toggle="modal" data-target="#myModal">Calendario Deportivo</a>
        </p>
    </div>
    <a href="#section2">
    ...
    <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
            ...
            <div class="row">
                ...
                <div class="col-xs-4 text-right">Las Categorias disponibles hasta este momento son de 1997,1998 y el año 2002, donde muchos jovenes se incorporan a nuestras filas.</div>
            </div>
            <br>
            <p class="text-center">
...
<script type="text/javascript" src="engine1/script.js"></script>
    ...
    <div class="container">
        ...
        <!--/row-->
        <p class="text-center" style="margin-top: 20px;">©2015</p>
