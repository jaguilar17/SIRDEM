            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <div class="cuadro-container">
                                ...
                                <asp:GridView runat="server" ID="gvPlantillaxEquipo" AutoGenerateColumns="False" ShowFooter="False" AllowPaging="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblPosicion" Text='<% #Bind("descripcionPosicion")%>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            <HeaderStyle Width="25%" />
                                            ...
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblPeso" Text='<% #Bind("peso")%>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            <HeaderStyle Width="25%" />
                                            ...
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblTalla" Text='<% #Bind("talla")%>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            <HeaderStyle Width="3%" />
                                            ...
                                            <ItemTemplate>
                                                <asp:Button runat="server" Text="Ver Ficha" CommandName="View" ID="btnViewReader"
                                                    ValidationGroup="Lector" ToolTip="Ficha tecnica" CssClass="btn btn-primary"
                      ...
                      <div class="cuadro-container">
                        <div class="cuadro-heading">
                            <span class="cuadro-title">Jugadores Convocatoria Aptos</span>
                        </div>
                        <div class="cuadro-body">
                            <div class="table-responsive">
                                <asp:GridView runat="server" ID="gvConvocables" AutoGenerateColumns="False" ShowFooter="False" AllowPaging="True"
                                   BorderWidth="0px" CssClass="table table-bordered"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                <asp:Button runat="server" Text="Asignar" CommandName="View" ID="btnViewReader"
                                                    ValidationGroup="Lector" ToolTip="Ficha tecnica" CssClass="btn btn-primary"
                                                    CommandArgument='<% #Bind("codJugador")%>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
